  ...
  const terms = [
    {
      ...
      input: breakdown.severity.input.toString(),
      weighted: breakdown.severity.weighted,
      color: 'bg-red-500',
    },
    {
      label: 'Reports',
      sublabel: `${breakdown.reports.input} unique reporter${breakdown.reports.input !== 1 ? 's' : ''}`,
      input: `ln(1+${breakdown.reports.input})`,
      weighted: breakdown.reports.weighted,
      color: 'bg-blue-500',
    },
    {
      label: 'Age',
      sublabel: `${breakdown.age.input} day${breakdown.age.input !== 1 ? 's' : ''} open`,
      input: `${breakdown.age.input}d`,
      weighted: breakdown.age.weighted,
      color: 'bg-amber-500',
    },
    {
      label: 'Recurrence',
      sublabel: breakdown.recurrence.input > 0 ? 'Location failed before' : 'First occurrence',
      input: breakdown.recurrence.input.toString(),
      weighted: breakdown.recurrence.weighted,
      color: 'bg-violet-500',
    },
  ];
